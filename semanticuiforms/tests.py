...
class CharFieldTestCase(TestCase):
	""" CharField is a generic field meaning that anything that passes on
			this field would also pass on any other field """
	...
	def test_attributes(self):
		"""Test that custom and private attributes work"""
		html = render_field(
